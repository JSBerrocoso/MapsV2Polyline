/***
 * Copyright (c) 2012 CommonsWare, LLC Licensed under the Apache License, Version 2.0 (the "License"); you may not use this file except in compliance
	...
	protected void onCreate(Bundle savedInstanceState){
		...
		if( readyToGo()){
			...
			PolylineOptions line = new PolylineOptions()
					.add( 	new LatLng( 40.70686417491799, -74.01572942733765),
							new LatLng( 40.76866299974387, -73.98268461227417),
							new LatLng( 40.765136435316755, -73.97989511489868),
							new LatLng( 40.748963847316034, -73.96807193756104))
					.width( 5)
					.color( Color.RED);
			...
			PolygonOptions area = new PolygonOptions()
					.add( 	new LatLng( 40.748429, -73.984573),
